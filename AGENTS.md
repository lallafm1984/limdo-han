...
- `docs/1차-목표-작업-기획서.md`는 1차 목표의 지속 계약이다. 현재 활성 루프가 끝난 뒤에는 문서의 미충족 항목 중 가장 앞선 제품 작업 또는 가장 높은 결함 하나를 다음 루프로 만들고, 세 메뉴·디자인·연출·QA·아이 대리 시뮬레이션 관문을 모두 통과할 때까지 자동 전환을 계속한다.
