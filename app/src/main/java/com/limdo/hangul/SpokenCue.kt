...
internal enum class SpokenCue(val utterance: String) {
    ...
    INITIAL_DEO("오른쪽으로 그려봐. 다음은 아래쪽, 오른쪽. 다음은 아래쪽. 마지막은 왼쪽."),
    SUCCESS_DEO("잘했어! 더를 완성했어."),
    INITIAL_DYEO("오른쪽으로 그려봐. 다음은 아래쪽, 오른쪽. 다음은 아래쪽. 위 선은 왼쪽. 아래 선도 왼쪽."),
    SUCCESS_DYEO("잘했어! 뎌를 완성했어."),
    INITIAL_DO("오른쪽으로 그려봐. 다음은 아래쪽, 오른쪽. 아래 긴 선은 오른쪽. 마지막은 위쪽."),
    SUCCESS_DO("잘했어! 도를 완성했어."),
    INITIAL_DYO("오른쪽. 아래쪽, 오른쪽. 긴 선 오른쪽. 왼쪽 선 위쪽. 오른쪽 선 위쪽."),
    SUCCESS_DYO("잘했어! \uB434를 완성했어."),
    INITIAL_DU("오른쪽. 아래쪽, 오른쪽. 긴 선 오른쪽. 마지막은 아래쪽."),
    SUCCESS_DU("잘했어! 두를 완성했어."),
    INITIAL_DYU("오른쪽. 아래쪽, 오른쪽. 긴 선 오른쪽. 왼쪽 선은 아래쪽. 오른쪽 선도 아래쪽."),
    SUCCESS_DYU("잘했어! 듀를 완성했어."),
    INITIAL_DEU("오른쪽. 아래쪽, 오른쪽. 마지막은 아래 긴 선을 오른쪽으로."),
    SUCCESS_DEU("잘했어! 드를 완성했어."),
    INITIAL_DI("오른쪽. 아래쪽, 오른쪽. 마지막은 오른쪽 긴 선을 아래쪽으로."),
    SUCCESS_DI("잘했어! 디를 완성했어."),
    ...
    INITIAL_REO("오른쪽 아래. 가운데를 오른쪽. 왼쪽 아래와 바닥. 다음은 아래. 마지막은 왼쪽."),
    SUCCESS_REO("잘했어! 러를 완성했어."),
    INITIAL_RYEO("오른쪽 아래. 가운데를 오른쪽. 왼쪽 아래와 바닥. 다음은 아래. 위 선은 왼쪽. 아래 선도 왼쪽."),
    SUCCESS_RYEO("잘했어! 려를 완성했어."),
