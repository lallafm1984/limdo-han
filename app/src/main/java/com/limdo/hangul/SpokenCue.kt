...
internal enum class SpokenCue(val utterance: String) {
    ...
    INITIAL_NYEO("\uB2C8\uC740\uC744 \uC544\uB798 \uC624\uB978\uCABD. \uC138\uB85C\uB294 \uC544\uB798\uCABD. \uC704 \uC120\uC740 \uC67C\uCABD. \uC544\uB798 \uC120\uB3C4 \uC67C\uCABD."),
    SUCCESS_NYEO("\uC798\uD588\uC5B4! \uB140\uB97C \uC644\uC131\uD588\uC5B4."),
    INITIAL_NO("니은을 아래 오른쪽. 아래 긴 선은 오른쪽. 마지막은 위쪽."),
    SUCCESS_NO("잘했어! 노를 완성했어."),
    INITIAL_NYO("니은을 아래 오른쪽. 아래 긴 선은 오른쪽. 왼쪽 선은 위쪽. 오른쪽 선도 위쪽."),
    SUCCESS_NYO("잘했어! 뇨를 완성했어."),
    INITIAL_NU("니은을 아래 오른쪽. 아래 긴 선은 오른쪽. 마지막은 아래쪽."),
    SUCCESS_NU("잘했어! 누를 완성했어."),
    INITIAL_NYU("니은을 아래 오른쪽. 아래 긴 선은 오른쪽. 왼쪽 선은 아래쪽. 오른쪽 선도 아래쪽."),
    SUCCESS_NYU("잘했어! 뉴를 완성했어."),
    INITIAL_NEU("니은을 아래 오른쪽. 마지막은 아래 긴 선을 오른쪽으로."),
    SUCCESS_NEU("잘했어! 느를 완성했어."),
    INITIAL_NI("니은을 아래 오른쪽. 마지막은 오른쪽 긴 선을 아래로."),
    SUCCESS_NI("잘했어! 니를 완성했어."),
