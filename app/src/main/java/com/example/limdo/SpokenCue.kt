...
internal enum class SpokenCue(val utterance: String) {
    ...
    INITIAL_JIEUT("위를 오른쪽으로. 다음은 왼쪽 아래로. 마지막은 오른쪽 아래로."),
    SUCCESS_JIEUT("잘했어! 지읏을 완성했어."),
    INITIAL_CHIEUT("짧게 오른쪽으로. 다음은 길게 오른쪽으로. 다음은 왼쪽 아래로. 마지막은 오른쪽 아래로."),
    SUCCESS_CHIEUT("잘했어! 치읓을 완성했어."),
    INITIAL_KIEUK("오른쪽, 모서리에서 아래쪽으로. 다음은 가운데를 오른쪽으로."),
    SUCCESS_KIEUK("잘했어! 키읔을 완성했어."),
    INITIAL_TIEUT("위를 오른쪽으로. 다음은 가운데를 오른쪽으로. 마지막은 왼쪽 아래와 바닥을 이어봐."),
    SUCCESS_TIEUT("잘했어! 티읕을 완성했어."),
    INITIAL_PIEUP("왼쪽을 아래로. 다음은 오른쪽을 아래로. 다음은 위를 오른쪽으로. 마지막은 아래를 오른쪽으로."),
    ...
    INITIAL_BA("왼쪽 아래. 오른쪽 아래. 위를 오른쪽. 가운데와 아래. 다음은 아래. 마지막은 오른쪽."),
    ...
    INITIAL_JA("위를 오른쪽. 다음은 왼쪽 아래. 다음은 오른쪽 아래. 다음은 아래. 마지막은 오른쪽."),
    SUCCESS_JA("잘했어! 자를 완성했어."),
    INITIAL_CHA("짧게 오른쪽. 길게 오른쪽. 왼쪽 아래. 오른쪽 아래. 아래. 마지막은 오른쪽."),
    SUCCESS_CHA("잘했어! 차를 완성했어."),
    INITIAL_KA("오른쪽 아래. 다음은 가운데를 오른쪽. 다음은 아래. 마지막은 오른쪽."),
    SUCCESS_KA("잘했어! 카를 완성했어."),
    INITIAL_TA("위를 오른쪽. 다음은 가운데를 오른쪽. 다음은 왼쪽 아래와 바닥. 다음은 아래. 마지막은 오른쪽."),
